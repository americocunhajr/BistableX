...
[disp_poinc, velo_poinc, disp_interp, velo_interp, time_interp] = poincare_estimation(time_vector,ss_disp,ss_velo,6.5,163840);
%%
disp = disp_interp(end*0.1:163840/2048:end);
velo = velo_interp(end*0.1:163840/2048:end);
...
%%
save('data_poincare_chaos_sym','disp',"velo",'disp_map',"velo_map",'volt','time_vector')